...
from app.core.db.endpoint_creator import EndpointCreator
...
class ModelView:
    r"""
    View class for managing CRUD operations and UI for database models in Kodaii admin interface.
    ...
    def __init__(
        ...
        self.crud: KodaiiCRUD[Any, Any, Any, Any, Any, Any] = KodaiiCRUD(self.model)
