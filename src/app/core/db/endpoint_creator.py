...
from app.core.db.paginated import ListResponse, PaginatedListResponse
from app.core.db.types import (
    CreateSchemaType,
    DeleteSchemaType,
    ModelType,
    SelectSchemaType,
...
from app.core.db.helper import (
    CRUDMethods,
    FilterConfig,
...
from app.core.db.paginated.schemas import (
...
class EndpointCreator:
    ...
    Attributes:
        ...
        crud: An optional KodaiiCRUD instance. If not provided, uses `KodaiiCRUD(model)`.
    ...
    Examples:
        ...
        ??? example "`mymodel/model.py`"
            ...
            ```python
            --8<--
            kodaiicrud/examples/mymodel/model.py:imports
            kodaiicrud/examples/mymodel/model.py:model_simple
            --8<--
            ```
        ...
        ??? example "`mymodel/schemas.py`"
            ...
            ```python
            --8<--
            kodaiicrud/examples/mymodel/schemas.py:imports
            kodaiicrud/examples/mymodel/schemas.py:createschema
            kodaiicrud/examples/mymodel/schemas.py:updateschema
            --8<--
            ```

        ```python
        from fastapi import FastAPI
        from kodaiicrud import EndpointCreator
        ...
        ```python
        from fastapi import FastAPI
        from kodaiicrud import EndpointCreator, FilterConfig
